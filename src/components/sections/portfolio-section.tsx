...
const portfolioItemsData = [
  ...
  { id: 3, title: 'Sattvik Meal Box Ad', category: 'advertisement', imageUrl: 'https://placehold.co/600x450.png', description: 'Promotional design for Hare Krishna Sattvik Meal Box, highlighting delicious, nutritious, and soul-enriching meals.', dataAiHint: 'sattvik meal box' },
