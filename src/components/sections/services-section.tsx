        ...
        <div className="grid md:grid-cols-12 gap-10 md:gap-16 min-h-[600px] md:min-h-[700px]">
          ...
          >
            {servicesData.map((service, index) => (
              ...
              >
                <service.icon className={cn("h-8 w-8 mr-5 shrink-0 transition-colors", activeServiceIndex === index ? "text-primary" : "text-accent group-hover:text-primary")} />
                <div>
                  ...
                  <p className={cn("text-base transition-colors", activeServiceIndex === index ? "text-primary/90" : "text-muted-foreground group-hover:text-foreground/80")}>{service.shortDescription}</p>
                </div>
                <ChevronRight className={cn("h-6 w-6 ml-auto shrink-0 transition-all duration-300 ease-out", activeServiceIndex === index ? "opacity-100 translate-x-0 text-primary" : "opacity-0 -translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 text-muted-foreground")} />
              </Button>
            ))}
          </div>
